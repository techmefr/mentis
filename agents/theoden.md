...
**Scope**: the `.cs` files of the diff. When the instruction hands you a file scope, you review only those files —
...
## 10. Comment style (direct, short, error-free, .NET-learner mode)

...
§2 point 4 (protected shared resources) added 2026-08-11, generalised from the org catalogue
an org-specific skill — a real org hard-interdiction skill naming one specific SQL Server

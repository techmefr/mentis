...
**Boundary with the the org catalogue plugin.** Its `design-patterns` plugin holds per-pattern
...
A dedup audit on 2026-08-06 found the installed the org catalogue marketplace already ships four

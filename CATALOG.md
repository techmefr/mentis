...
|---|---|---|---|---|
| laravel | 65 / 79,825 | 3 / 35,501 | −44,324 | x2.25 |
| csharp | 37 / 56,718 | 1 / 23,360 | −33,358 | x2.43 |
...
```
laravel: laravel-conventions 22,315, php-patterns 6,068, inertia-conventions 7,118
csharp: dotnet-conventions 23,360

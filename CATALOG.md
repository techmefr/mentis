...
|---|---|---|---|---|
| laravel | 65 / 79,825 | 3 / 29,722 | −50,103 | x2.69 |
| csharp | 37 / 56,718 | 1 / 14,286 | −42,432 | x3.97 |
...
```
laravel: laravel-conventions 16,536, php-patterns 6,068, inertia-conventions 7,118
csharp: dotnet-conventions 14,286

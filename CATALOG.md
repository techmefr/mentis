...
|---|---|---|---|---|
| laravel | 65 / 79,825 | 3 / 38,033 | −41,792 | x2.1 |
| csharp | 37 / 56,718 | 1 / 26,730 | −29,988 | x2.12 |
| python | 20 / 22,097 | 2 / 15,907 | −6,190 | x1.39 |
...
```
laravel: laravel-conventions 24,847, php-patterns 6,068, inertia-conventions 7,118
csharp: dotnet-conventions 26,730
python: python-conventions 12,624, data-pipeline-conventions 3,283

...
|---|---|---|---|---|
| laravel | 65 / 79,825 | 3 / 40,758 | −39,067 | x1.96 |
| csharp | 37 / 56,718 | 1 / 29,969 | −26,749 | x1.89 |
...
```
laravel: laravel-conventions 27,572, php-patterns 6,068, inertia-conventions 7,118
csharp: dotnet-conventions 29,969

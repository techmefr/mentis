...
| market skills repository (companion) | `architecture/preserving-productive-tensions`, `research/tracing-knowledge-lineages` | / | 🔎 (read but not yet judged; the first sounds relevant to `archi`/`documentation-adr`, the second to sourcing itself) |

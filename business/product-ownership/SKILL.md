...
- **The story document** — its anatomy, its formatting, its Jira fields and labels, reviewing it,
  criticality modes → the `project-management` skills of the the org catalogue plugin
...
installed the org catalogue marketplace found nine `project-management` skills already covering the
